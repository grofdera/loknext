<div class="px-6 py-6 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
    <div class="xl:w-0 xl:flex-1">
        <h2 class="text-2xl font-extrabold leading-8 tracking-tight text-yellow-500 sm:text-3xl sm:leading-9">
            Receive alert about new commit or pull request on your github
        </h2>
        <p class="max-w-3xl mt-3 text-lg leading-6 text-gray-400">
    ...
    <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
        ...
        <p class="mt-3 text-sm leading-5 text-gray-400">
